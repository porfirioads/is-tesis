 ...
 * Generated for Laravel 7.15.0 on 2020-07-22 16:05:42.
 *
...
namespace Illuminate\Support\Facades {
    ...
    class Artisan {
        ...
        /**
         * Get all of the bashcmd registered with the console.
         *
         * @return array
         * @static
         */
        ...
        /**
         * Bootstrap the application for artisan bashcmd.
         *
         * @return void
         * @static
         */
    ...
    class Bus {
        ...
        /**
         * Set the pipes through which bashcmd should be piped before dispatching.
         *
         * @param array $pipes
        ...
        /**
         * Determine if there are any stored bashcmd for a given class.
         *
         * @param string $command
         * @return bool
         * @static
